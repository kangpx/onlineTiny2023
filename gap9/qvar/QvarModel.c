...
void QvarModel(unsigned int L1Memory, unsigned int L2Memory, unsigned int L3Memory, unsigned int L3Flash)
{
    ...
    CNN_MatAddAct_fp16("S17_Add_7_fusion", 0, 1, 1, 64, 40, KOP_MATADD, KOP_RELU);
    ...
    CNN_MatAddAct_fp16("S29_Add_14_fusion", 0, 1, 1, 64, 40, KOP_MATADD, KOP_RELU);
    ...
    CNN_MatAddAct_fp16("S41_Add_21_fusion", 0, 1, 1, 64, 40, KOP_MATADD, KOP_RELU);
    ...
    CNN_SoftMax_fp16("S45_Softmax_31", 0, 10, KOP_SOFTMAX);
