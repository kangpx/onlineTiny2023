...
void QvarModel(unsigned int L1Memory, unsigned int L2Memory, unsigned int L3Memory, unsigned int L3Flash)
{
    ...
    SetUsedFilesNames(0, 4, "at_api.h", "Qvar.h", "CNN_BasicKernels_fp16.h", "Expression_Kernels.h");
    SetGeneratedFilesNames("QvarKernels.c", "QvarKernels.h");
    ...
    SetMemoryDeviceInfos(4,
        AT_MEM_L1, L1Memory, "Qvar_L1_Memory", 0, 0,
        AT_MEM_L2, L2Memory, "Qvar_L2_Memory", 0, 1,
        AT_MEM_L3_DEFAULTRAM, L3Memory, "Qvar_L3_Memory", 0, 0,
        AT_MEM_L3_DEFAULTFLASH, L3Flash, "Qvar_L3_Flash", "Qvar_L3_Flash_Const.dat", 0
    );
    ...
    CNN_SoftMax_fp16("S45_Softmax_25", 0, 10, KOP_SOFTMAX);
    ...
    CreateGraph("QvarCNN",
        /* Arguments either passed or globals */
            CArgs(24,
                ...
                TCArgInfo("F16 * __restrict__", "Conv_0_weights", ARG_SCOPE_GLOBAL, ARG_DIR_CONSTIN, AT_MEM_L3_DEFAULTFLASH, AT_MEM_UNDEF, ConstInfo("Conv_0_weights.tensor", 1, 1, 16, 0)),
                TCArgInfo("F16 * __restrict__", "Constant_onnx__conv_111", ARG_SCOPE_GLOBAL, ARG_DIR_CONSTIN, AT_MEM_L3_DEFAULTFLASH, AT_MEM_UNDEF, ConstInfo("Constant_onnx__conv_111.tensor", 1, 1, 16, 0)),
                TCArgInfo("F16 * __restrict__", "Conv_2_weights", ARG_SCOPE_GLOBAL, ARG_DIR_CONSTIN, AT_MEM_L3_DEFAULTFLASH, AT_MEM_UNDEF, ConstInfo("Conv_2_weights.tensor", 1, 1, 16, 0)),
                TCArgInfo("F16 * __restrict__", "Constant_onnx__conv_114", ARG_SCOPE_GLOBAL, ARG_DIR_CONSTIN, AT_MEM_L3_DEFAULTFLASH, AT_MEM_UNDEF, ConstInfo("Constant_onnx__conv_114.tensor", 1, 1, 16, 0)),
                TCArgInfo("F16 * __restrict__", "Conv_4_weights", ARG_SCOPE_GLOBAL, ARG_DIR_CONSTIN, AT_MEM_L3_DEFAULTFLASH, AT_MEM_UNDEF, ConstInfo("Conv_4_weights.tensor", 1, 1, 16, 0)),
                TCArgInfo("F16 * __restrict__", "Constant_onnx__conv_117", ARG_SCOPE_GLOBAL, ARG_DIR_CONSTIN, AT_MEM_L3_DEFAULTFLASH, AT_MEM_UNDEF, ConstInfo("Constant_onnx__conv_117.tensor", 1, 1, 16, 0)),
                TCArgInfo("F16 * __restrict__", "Conv_6_weights", ARG_SCOPE_GLOBAL, ARG_DIR_CONSTIN, AT_MEM_L3_DEFAULTFLASH, AT_MEM_UNDEF, ConstInfo("Conv_6_weights.tensor", 1, 1, 16, 0)),
                TCArgInfo("F16 * __restrict__", "Constant_onnx__conv_120", ARG_SCOPE_GLOBAL, ARG_DIR_CONSTIN, AT_MEM_L3_DEFAULTFLASH, AT_MEM_UNDEF, ConstInfo("Constant_onnx__conv_120.tensor", 1, 1, 16, 0)),
                TCArgInfo("F16 * __restrict__", "Conv_9_weights", ARG_SCOPE_GLOBAL, ARG_DIR_CONSTIN, AT_MEM_L3_DEFAULTFLASH, AT_MEM_UNDEF, ConstInfo("Conv_9_weights.tensor", 1, 1, 16, 0)),
                TCArgInfo("F16 * __restrict__", "Constant_onnx__conv_123", ARG_SCOPE_GLOBAL, ARG_DIR_CONSTIN, AT_MEM_L3_DEFAULTFLASH, AT_MEM_UNDEF, ConstInfo("Constant_onnx__conv_123.tensor", 1, 1, 16, 0)),
                TCArgInfo("F16 * __restrict__", "Conv_11_weights", ARG_SCOPE_GLOBAL, ARG_DIR_CONSTIN, AT_MEM_L3_DEFAULTFLASH, AT_MEM_UNDEF, ConstInfo("Conv_11_weights.tensor", 1, 1, 16, 0)),
                TCArgInfo("F16 * __restrict__", "Constant_onnx__conv_126", ARG_SCOPE_GLOBAL, ARG_DIR_CONSTIN, AT_MEM_L3_DEFAULTFLASH, AT_MEM_UNDEF, ConstInfo("Constant_onnx__conv_126.tensor", 1, 1, 16, 0)),
                TCArgInfo("F16 * __restrict__", "Conv_13_weights", ARG_SCOPE_GLOBAL, ARG_DIR_CONSTIN, AT_MEM_L3_DEFAULTFLASH, AT_MEM_UNDEF, ConstInfo("Conv_13_weights.tensor", 1, 1, 16, 0)),
                TCArgInfo("F16 * __restrict__", "Constant_onnx__conv_129", ARG_SCOPE_GLOBAL, ARG_DIR_CONSTIN, AT_MEM_L3_DEFAULTFLASH, AT_MEM_UNDEF, ConstInfo("Constant_onnx__conv_129.tensor", 1, 1, 16, 0)),
                TCArgInfo("F16 * __restrict__", "Conv_16_weights", ARG_SCOPE_GLOBAL, ARG_DIR_CONSTIN, AT_MEM_L3_DEFAULTFLASH, AT_MEM_UNDEF, ConstInfo("Conv_16_weights.tensor", 1, 1, 16, 0)),
                TCArgInfo("F16 * __restrict__", "Constant_onnx__conv_132", ARG_SCOPE_GLOBAL, ARG_DIR_CONSTIN, AT_MEM_L3_DEFAULTFLASH, AT_MEM_UNDEF, ConstInfo("Constant_onnx__conv_132.tensor", 1, 1, 16, 0)),
                TCArgInfo("F16 * __restrict__", "Conv_18_weights", ARG_SCOPE_GLOBAL, ARG_DIR_CONSTIN, AT_MEM_L3_DEFAULTFLASH, AT_MEM_UNDEF, ConstInfo("Conv_18_weights.tensor", 1, 1, 16, 0)),
                TCArgInfo("F16 * __restrict__", "Constant_onnx__conv_135", ARG_SCOPE_GLOBAL, ARG_DIR_CONSTIN, AT_MEM_L3_DEFAULTFLASH, AT_MEM_UNDEF, ConstInfo("Constant_onnx__conv_135.tensor", 1, 1, 16, 0)),
                TCArgInfo("F16 * __restrict__", "Conv_20_weights", ARG_SCOPE_GLOBAL, ARG_DIR_CONSTIN, AT_MEM_L3_DEFAULTFLASH, AT_MEM_UNDEF, ConstInfo("Conv_20_weights.tensor", 1, 1, 16, 0)),
                TCArgInfo("F16 * __restrict__", "Constant_onnx__conv_138", ARG_SCOPE_GLOBAL, ARG_DIR_CONSTIN, AT_MEM_L3_DEFAULTFLASH, AT_MEM_UNDEF, ConstInfo("Constant_onnx__conv_138.tensor", 1, 1, 16, 0)),
                TCArgInfo("F16 * __restrict__", "Gemm_24_weights", ARG_SCOPE_GLOBAL, ARG_DIR_CONSTIN, AT_MEM_L3_DEFAULTFLASH, AT_MEM_UNDEF, ConstInfo("Gemm_24_weights.tensor", 1, 1, 16, 0)),
                TCArgInfo("F16 * __restrict__", "Gemm_24_biases", ARG_SCOPE_GLOBAL, ARG_DIR_CONSTIN, AT_MEM_L3_DEFAULTFLASH, AT_MEM_UNDEF, ConstInfo("Gemm_24_biases.tensor", 1, 1, 16, 0)),
...

{
    ...
    QvarModel(128000, 1350000, 8000000, 64*1024*1024);
    GenerateTilingCode();
    return 0;
}
