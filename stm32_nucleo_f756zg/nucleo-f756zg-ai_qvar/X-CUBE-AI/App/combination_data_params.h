...
#define AI_COMBINATION_DATA_WEIGHTS_SIZES \
  { 256, 49152, 256, 49152, 256, 49152, 256, 49152, 256, 49152, 256, 49152, 256, 49152, 256, 49152, 256, 49152, 256, 102400, 40, 6912, }
#define AI_COMBINATION_DATA_WEIGHTS_SIZE         (554280)
...
#define AI_COMBINATION_DATA_WEIGHT_20_SIZE        (102400)
#define AI_COMBINATION_DATA_WEIGHT_21_SIZE        (40)
#define AI_COMBINATION_DATA_WEIGHT_22_SIZE        (6912)
