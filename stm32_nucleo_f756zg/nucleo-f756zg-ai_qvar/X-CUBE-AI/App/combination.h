...
#define AI_COMBINATION_IN_1_CHANNEL     (9)
#define AI_COMBINATION_IN_1_HEIGHT      (40)
#define AI_COMBINATION_IN_1_SIZE        (9 * 40)
#define AI_COMBINATION_IN_1_SIZE_BYTES  (1440)
...
#define AI_COMBINATION_OUT_1_CHANNEL     (10)
#define AI_COMBINATION_OUT_1_SIZE        (10)
#define AI_COMBINATION_OUT_1_SIZE_BYTES  (40)
