...
#define AI_COMBINATION_ORIGIN_MODEL_NAME   "fold_0_pre_combination_fullvalid_b32"
...
#define AI_COMBINATION_IN_1_CHANNEL     (45)
#define AI_COMBINATION_IN_1_HEIGHT      (19)
#define AI_COMBINATION_IN_1_SIZE        (45 * 19)
#define AI_COMBINATION_IN_1_SIZE_BYTES  (3420)
...
#define AI_COMBINATION_OUT_1_CHANNEL     (8)
#define AI_COMBINATION_OUT_1_SIZE        (8)
#define AI_COMBINATION_OUT_1_SIZE_BYTES  (32)
