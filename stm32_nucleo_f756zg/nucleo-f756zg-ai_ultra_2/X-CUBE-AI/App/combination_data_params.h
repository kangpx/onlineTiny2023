...
#define AI_COMBINATION_DATA_ACTIVATIONS_SIZES \
  { 5632, }
#define AI_COMBINATION_DATA_ACTIVATIONS_SIZE     (5632)
#define AI_COMBINATION_DATA_ACTIVATIONS_COUNT    (1)
#define AI_COMBINATION_DATA_ACTIVATION_1_SIZE    (5632)



#define AI_COMBINATION_DATA_WEIGHTS_SIZES \
  { 128, 12288, 128, 12288, 128, 12288, 128, 12288, 128, 12288, 128, 19456, 32, 17280, 128, 12288, 128, 12288, 128, 12288, 128, 12288, }
#define AI_COMBINATION_DATA_WEIGHTS_SIZE         (148640)
...
#define AI_COMBINATION_DATA_WEIGHT_12_SIZE        (19456)
#define AI_COMBINATION_DATA_WEIGHT_13_SIZE        (32)
#define AI_COMBINATION_DATA_WEIGHT_14_SIZE        (17280)
