...
#define AI_COMBINATION_MODEL_SIGNATURE     "2cdd72e9883a93f1abce539befc82aa9"
...
#define AI_TOOLS_DATE_TIME   "Mon Jan 15 20:31:17 2024"
...
AI_TENSOR_OBJ_DECLARE(
  ...
  11, 0x0,
  AI_SHAPE_INIT(4, 1280, 12, 1, 1), AI_STRIDE_INIT(4, 4, 5120, 61440, 61440),
...
AI_TENSOR_OBJ_DECLARE(
  ...
  40, 0x0,
  AI_SHAPE_INIT(4, 7, 1, 3, 32), AI_STRIDE_INIT(4, 4, 28, 896, 896),
...
AI_NETWORK_OBJ_DECLARE(
  ...
  AI_BUFFER_INIT(AI_FLAG_NONE,  AI_BUFFER_FORMAT_U8,
    AI_BUFFER_SHAPE_INIT(AI_SHAPE_BCWH, 4, 1, 176048, 1, 1),
    176048, NULL, NULL),
  AI_BUFFER_INIT(AI_FLAG_NONE,  AI_BUFFER_FORMAT_U8,
