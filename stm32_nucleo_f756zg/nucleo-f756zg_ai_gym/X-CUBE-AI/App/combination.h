...
#ifndef AI_COMBINATION_H
#define AI_COMBINATION_H
#pragma once
...
#define AI_COMBINATION_ORIGIN_MODEL_NAME   "fold_1_pre_combination_fullvalid_b32_s20"

/******************************************************************************/
#define AI_COMBINATION_ACTIVATIONS_ALIGNMENT   (4)
#define AI_COMBINATION_INPUTS_IN_ACTIVATIONS   (4)
#define AI_COMBINATION_OUTPUTS_IN_ACTIVATIONS  (4)

/******************************************************************************/
#define AI_COMBINATION_IN_NUM        (1)

AI_DEPRECATED
#define AI_COMBINATION_IN \
  ai_combination_inputs_get(AI_HANDLE_NULL, NULL)

#define AI_COMBINATION_IN_SIZE { \
  AI_COMBINATION_IN_1_SIZE, \
}
#define AI_COMBINATION_IN_SIZE_BYTES { \
  AI_COMBINATION_IN_1_SIZE_BYTES, \
}
#define AI_COMBINATION_IN_1_FORMAT      AI_BUFFER_FORMAT_FLOAT
#define AI_COMBINATION_IN_1_CHANNEL     (7)
#define AI_COMBINATION_IN_1_HEIGHT      (40)
#define AI_COMBINATION_IN_1_SIZE        (7 * 40)
#define AI_COMBINATION_IN_1_SIZE_BYTES  (1120)

/******************************************************************************/
#define AI_COMBINATION_OUT_NUM       (1)

AI_DEPRECATED
#define AI_COMBINATION_OUT \
  ai_combination_outputs_get(AI_HANDLE_NULL, NULL)

#define AI_COMBINATION_OUT_SIZE { \
  AI_COMBINATION_OUT_1_SIZE, \
}
#define AI_COMBINATION_OUT_SIZE_BYTES { \
  AI_COMBINATION_OUT_1_SIZE_BYTES, \
}
#define AI_COMBINATION_OUT_1_FORMAT      AI_BUFFER_FORMAT_FLOAT
#define AI_COMBINATION_OUT_1_CHANNEL     (12)
#define AI_COMBINATION_OUT_1_SIZE        (12)
#define AI_COMBINATION_OUT_1_SIZE_BYTES  (48)

/******************************************************************************/
#define AI_COMBINATION_N_NODES (25)


AI_API_DECLARE_BEGIN

/*!
 * @defgroup combination
 ...
 * @ref ai_combination_create. Both the activations memory buffer 
 ...
 * using @ref ai_combination_get_error
 */
AI_API_ENTRY
 ...
 */
AI_API_ENTRY
ai_buffer* ai_combination_inputs_get(
 ...
 */
AI_API_ENTRY
ai_buffer* ai_combination_outputs_get(
  ai_handle network, ai_u16 *n_buffer);
 ...
 * header generated by the code generation tool. See AI_COMBINATION_*
 * defines into file @ref combination.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
 ...
 */
AI_API_ENTRY
ai_i32 ai_combination_forward(
  ai_handle network, const ai_buffer* input);

AI_API_DECLARE_END

#endif /* AI_COMBINATION_H */
