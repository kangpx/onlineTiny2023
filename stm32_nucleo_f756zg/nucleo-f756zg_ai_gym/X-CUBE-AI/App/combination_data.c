...
ai_buffer g_combination_data_map_activations[AI_COMBINATION_DATA_ACTIVATIONS_COUNT] = {
  AI_BUFFER_INIT(AI_FLAG_NONE,  AI_BUFFER_FORMAT_U8,
    ...
    11008, NULL, NULL),    /* heap_overlay_pool */
  };
ai_buffer g_combination_data_map_weights[AI_COMBINATION_DATA_WEIGHTS_COUNT] = {
  ...
  AI_BUFFER_INIT(AI_FLAG_NONE,  AI_BUFFER_FORMAT_U8,
    ...
    61440, NULL, s_combination_input_80_weights_array_u64),   /* input_80_weights_array */
  AI_BUFFER_INIT(AI_FLAG_NONE,  AI_BUFFER_FORMAT_U8,
    AI_BUFFER_SHAPE_INIT(AI_SHAPE_BCWH, 4, 1, 48, 1, 1),
    48, NULL, s_combination_input_80_bias_array_u64),   /* input_80_bias_array */
  AI_BUFFER_INIT(AI_FLAG_NONE,  AI_BUFFER_FORMAT_U8,
    AI_BUFFER_SHAPE_INIT(AI_SHAPE_BCWH, 4, 1, 2688, 1, 1),
    2688, NULL, s_combination_input_4_weights_array_u64),   /* input_4_weights_array */
  AI_BUFFER_INIT(AI_FLAG_NONE,  AI_BUFFER_FORMAT_U8,
    AI_BUFFER_SHAPE_INIT(AI_SHAPE_BCWH, 4, 1, 128, 1, 1),
