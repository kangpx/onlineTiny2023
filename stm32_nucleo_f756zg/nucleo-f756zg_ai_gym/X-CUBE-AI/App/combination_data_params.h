...
#define AI_COMBINATION_DATA_WEIGHTS_SIZES \
  { 128, 12288, 128, 12288, 128, 12288, 128, 12288, 128, 12288, 128, 61440, 48, 2688, 128, 12288, 128, 12288, 128, 12288, 128, 12288, }
#define AI_COMBINATION_DATA_WEIGHTS_SIZE         (176048)
...
#define AI_COMBINATION_DATA_WEIGHT_12_SIZE        (61440)
#define AI_COMBINATION_DATA_WEIGHT_13_SIZE        (48)
#define AI_COMBINATION_DATA_WEIGHT_14_SIZE        (2688)
