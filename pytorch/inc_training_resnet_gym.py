...
def main():
    ...
    # foldwise statistics
    fold_labels = [f'fold_{i}' for i in range(1, 11)]
    fold_metrics = {
        'accuracy_pre': [foldlog_pre.loc[i, 'accuracy'].round(4) for i in range(10)],
        'accuracy_onl_user': [foldlog_incu.loc[i, 'accuracy'].round(4) for i in range(10)],
        'accuray_onl_nonuser': [foldlog_incnu.loc[i, 'accuracy'].round(4) for i in range(10)],
        'macro_f1_pre': [foldlog_pre.loc[i, 'macro_f1'].round(4) for i in range(10)],
        'macro_f1_onl_user': [foldlog_incu.loc[i, 'macro_f1'].round(4) for i in range(10)],
        'macro_f1_onl_nonuser': [foldlog_incnu.loc[i, 'macro_f1'].round(4) for i in range(10)],
    } 
    ...
    plt.savefig(f'../figures/foldwise_gym_{"fullvalid" if not include_incnu else "partvalid"}.jpg')

    # classwise statistics
    class_labels = CLASSES
    class_metrics = {
        'precision_pre': [np.round(np.mean([foldlog_classwise_pre[i_fold][0][i_cls] for i_fold in range(10)]), 4) for i_cls in range(12)],
        'precision_onl_user': [np.round(np.mean([foldlog_classwise_incu[i_fold][0][i_cls] for i_fold in range(10)]), 4) for i_cls in range(12)],
        'precision_onl_nonuser': [np.round(np.mean([foldlog_classwise_incnu[i_fold][0][i_cls] for i_fold in range(10)]), 4) for i_cls in range(12)],
        'recall_pre': [np.round(np.mean([foldlog_classwise_pre[i_fold][1][i_cls] for i_fold in range(10)]), 4) for i_cls in range(12)],
        'recall_onl_user': [np.round(np.mean([foldlog_classwise_incu[i_fold][1][i_cls] for i_fold in range(10)]), 4) for i_cls in range(12)],
        'recall_onl_nonuser': [np.round(np.mean([foldlog_classwise_incnu[i_fold][1][i_cls] for i_fold in range(10)]), 4) for i_cls in range(12)],
        'f1_pre': [np.round(np.mean([foldlog_classwise_pre[i_fold][2][i_cls] for i_fold in range(10)]), 4) for i_cls in range(12)],
        'f1_onl_user': [np.round(np.mean([foldlog_classwise_incu[i_fold][2][i_cls] for i_fold in range(10)]), 4) for i_cls in range(12)],
        'f1_onl_nonuser': [np.round(np.mean([foldlog_classwise_incnu[i_fold][2][i_cls] for i_fold in range(10)]), 4) for i_cls in range(12)]
    } 
    
    x = np.array([3*i for i in range(12)])
    width = 0.3
    multiplier = 0
    ...
    plt.savefig(f'../figures/classwise_gym_{"fullvalid" if not include_incnu else "partvalid"}.jpg')
