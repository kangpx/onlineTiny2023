...
def get_embedding(x, fold):
    backbone_path = f'../saved_models/ultra/pt/fold_{fold}_pre_backbone_fullvalid_b32.pt'
...
if __name__ == '__main__':
    ...
    for fold in range(7):
        ...
        plt.savefig(f'../figures/ultra_tsne_fold{fold}.pdf')
